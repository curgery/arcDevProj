...
import IMG_3044 from '../../assets/IMG_3044.JPG';
...
export default function Header(props) {
  ...
  const menuOptions = [
    ...
    {name: 'Custom Software Development', link: '/customsoftware', activeIndex: 1, selectedIndex: 1 }, {name: 'iOS/Android App Development', link: '/mobileapps', activeIndex: 1, selectedIndex: 2 },
  ...
  const tabs = (
    <React.Fragment>
        ...
        <Button component={Link} to='/estimate' variant='contained' color="secondary" className={classes.button} onClick={() => props.setValue(false)}>
            Free Estimate
        </Button>
        ...
        <div className={classes.toolbarMargin} />   
            <List disablePadding>
                {routes.map(route => (
                    <ListItem
                        divider
                        key={`${route}${route.activeIndex}`}    button
                        component={Link}
                        to={route.link}
    ...
    return (
      ...
      <ElevationScroll>
          <AppBar position="fixed" className={classes.appbar} >
            ...
            {/* <img src={IMG_3044} alt="company logo" className={classes.logo}/> */}
