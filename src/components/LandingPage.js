            ...
            <Grid container justify='flex-end' alignItems='center' direction='row'>
                <Grid sm item className={classes.heroTextContainer}>
                   <Typography variant='h2' align='center'>
                       Bringing Robust Expansion<br />To  Innovative Technology
                    </Typography> 
                   <Grid container justify='center' className={classes.buttonContainer}>
                       ...
                       <Grid item>
                           <Button component={Link} to='/revolution' variant='outlined' onClick={() => props.setValue(2)} className={classes.learnButtonHero}><span style={{ marginRight: 10}}>Learn More</span>
            ...
            <Grid container direction='row' justify={matchesSM ? 'center' : undefined} className={classes.serviceContainer}>
                <Grid item style={{marginLeft: matchesSM ? 0 : '5em', textAlign: matchesSM ? 'center' : undefined}}>
                    ...
                    <Typography variant='subtitle1'>
                        Complete digital solutions, from investigation to{" "} <span className={classes.specialText}>implementation.</span>
                    </Typography>
